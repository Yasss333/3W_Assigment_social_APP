...
const Login = () => {
  ...
  return (
    <Box minHeight="100vh" display="flex" alignItems="center" justifyContent="center"
      sx={{ background: 'radial-gradient(ellipse at 60% 20%, rgba(108,99,255,0.12) 0%, transparent 60%)' }}>
      <Card sx={{ width: '100%', maxWidth: 420, mx: 2 }}>
        ...
        <CardContent sx={{ p: 4 }}>
          <Box textAlign="center" mb={4}>
            ...
            <Typography color="text.secondary" fontSize={14} mt={0.5}>Sign in to your account</Typography>
          </Box>
          ...
          <Typography textAlign="center" mt={3} fontSize={14} color="text.secondary">
            ...
            <Link component={RouterLink} to="/signup" sx={{ color: 'primary.main', fontWeight: 600 }}>Sign Up</Link>
          </Typography>
        </CardContent>
      </Card>
    </Box>
